...
\par Por definición, la \textit{Epidemiología Panorámica} integra conceptos y
  ...
  Así, éste enfoque es más que simplemente establecer
...
\par Dado lo ya mencionado, resulta natural que la \textit{Epidemiología Panorámica}
  promueva la noción de que la información
  satelital derivada de la observación de la Tierra y las tecnologías geoespaciales
  son herramientas escenciales \cite{hay_overview_rs} para abordar los problemas
  epidemiológicos relacionados a la transmisión de enfermedades por vectores.
  Utilizando se llevaron a cabo numerosos estudios interdisciplinarios enfocados
  en la generación de modelos, espaciales y temporales, orientados a predecir riesgo,
  basándose en condiciones ambientales derivadas de información satelital
  \cite{enao_gis_y_sr, fuller_costa_rica, madrin_correlating, arboleda_colombia}.
  En particular, en Argentina algunas de la experiencias en esta dirección son
  \cite{rotela_space_time, estallo_prevention, espinosa_temporal}. En ellas
  se aborda el problema de la epidemia del Dengue brindando herramientas
  operacionales \cite{porcasi_operative}.
  A su vez, en el caso ya mencionado de German y colaboradores
